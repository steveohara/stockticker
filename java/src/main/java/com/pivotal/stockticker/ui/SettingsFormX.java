 ...
 */
public class SettingsFormX extends JDialog implements CallbackInterface {
     ...
     */
    public SettingsFormX(CallbackInterface caller, Settings settings) {
        this.caller = caller;
...
//        setModal(true);
    ...
    private void initComponents() {
        ...
        btnNormalText.setBackground(new Color(153, 153, 153));

        btnUpColour.setBackground(new Color(0, 204, 204));

        btnDownColour.setBackground(new Color(255, 102, 102));

        btnUpArrowColour.setBackground(new Color(0, 204, 51));

        btnDownArrowColour.setBackground(Color.red);
        ...
        btnHighAlarm.setBackground(new Color(204, 204, 204));
        ...
        btnLowAlarm.setBackground(new Color(204, 204, 204));
        btnLowAlarm.setText("...");

        jLabel26.setHorizontalAlignment(SwingConstants.RIGHT);
        jLabel26.setText("Down Arrow Colour");

        btnBackground.setBackground(new Color(0, 0, 0));
        ...
        jLabel11.setFont(new Font("Helvetica Neue", 1, 13)); // NOI18N
        ...
        jLabel24.setFont(new Font("Helvetica Neue", 1, 13)); // NOI18N
        jLabel24.setForeground(new Color(204, 204, 204));
