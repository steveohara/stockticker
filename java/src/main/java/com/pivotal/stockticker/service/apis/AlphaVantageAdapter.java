                ...
                try {
                    ...
                    if (response.statusCode() != 200) {
                        ...
                        try {
                            ...
                            // Update rate details
                            price.setDayStart(Double.parseDouble((String)priceData.get("02. open")));
                            price.setDayHigh(Double.parseDouble((String)priceData.get("03. high")));
                            price.setDayLow(Double.parseDouble((String)priceData.get("04. low")));
                            price.setCurrentPrice(Double.parseDouble((String)priceData.get("05. price")));
